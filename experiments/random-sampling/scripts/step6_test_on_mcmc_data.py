...
RESULTS_DIR = Path("experiments/random-sampling/out/results/testing/mcmc_test_data_results")
PLOTS_DIR= Path("experiments/random-sampling/out/plots/testing_plots/mcmc_test_data_plots")
...
def plot_infected_only(results_list, targets, plots_dir, n_samples=8):
    ...
    axes = axes.flatten()
    fig.suptitle('UNIFORM RANDOM MODEL ON MCMC TEST SET (INFECTED (I) COMPARTMENT)',
        fontsize=22,
        fontweight='bold'
    )
