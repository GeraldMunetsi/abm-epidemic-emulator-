...
MODEL_DIR=Path("experiments/random-sampling/out/results/uniform_random_no_augmentation/validation")
PLOTS_DIR=Path("experiments/random-sampling/out/results/uniform_random_no_augmentation/validation")
