...
if __name__ == "__main__":
    ...
    # ── Output: write to split/ ───────────────────────────────
    out_path = SPLIT_DATA_DIR / args.output if args.output else \
        SPLIT_DATA_DIR / (Path(args.input).stem + "_split_augmented.pkl")
    ...
    csv_path = SPLIT_DATA_DIR / args.output_csv if args.output_csv else \
        SPLIT_DATA_DIR / (Path(args.input).stem + "_train_params.csv")
