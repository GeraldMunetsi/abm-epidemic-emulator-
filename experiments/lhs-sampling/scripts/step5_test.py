...
RESULTS_DIR= Path("experiments/lhs-sampling/out/results/testing/lhs_test_data_results")
PLOTS_DIR= Path("experiments/lhs-sampling/out/plots/testing_plots/lhs_testing_plots")
...
def plot_infected_only(results_list, targets, plots_dir, n_samples=8):
    ...
    axes = axes.flatten()
    fig.suptitle('lHS MODEL ON LHS TEST SET (INFECTED (I) COMPARTMENT)',
        fontsize=22,
        fontweight='bold'
    )
