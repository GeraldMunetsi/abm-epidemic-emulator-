...
RESULTS_DIR= Path("experiments/mcmc-sampling/out/results/testing/results_on_random_sampled_data")
PLOTS_DIR= Path("experiments/mcmc-sampling/out/plots/testing_plots/random_test_data")
...
def compute_relative_mae_i(predictions, targets):
    ...
    Returns
    -------
    mean_rel,std_rel, per_sample, mean_peak
    """
