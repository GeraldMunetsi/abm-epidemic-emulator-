...
from utils import (create_dataloaders, compute_metrics,
                   get_device, PARAM_MINS, PARAM_MAXS)

# CONSTANTS 
N = 100_000
N_TIMEPOINTS = 250
ratio = 58        # (⟨k²⟩ − ⟨k⟩)/⟨k⟩ for the BA network
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default=str(TEST_DATA_DIR))
