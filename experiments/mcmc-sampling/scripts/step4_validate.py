...
MODEL_DIR=Path("experiments/mcmc-sampling/out/results/validation")
PLOTS_DIR=Path("experiments/mcmc-sampling/out/plots/validation_plots")
...
if __name__ == "__main__":
    ...
    # Default filename 
    DATA_FILENAME = 'epidemic_data_age_adaptive_sobol_split_augmented.pkl'
    ...
    parser.add_argument('--data',
                        type=str,
                        default=str(SPLIT_DATA_DIR / DATA_FILENAME),  # ← UPDATED
    ...
    print(f"  Data file   : {data_path.resolve()}")        # ← now prints full path
    ...
    dataloaders = create_dataloaders(str(data_path), batch_size=40)  # ← pass full path
...
if __name__ == "__main__":
    ...
    EXPERIMENT_DIRS = {
        ...
        'mcmc'   : 'experiments/mcmc-sampling',
    }

    def resolve_paths(experiment):
        base = Path(EXPERIMENT_DIRS[experiment])
        return (
            base / 'out' / 'trained-models',
            base / 'out' / 'plots',
            base / 'out' / 'results',
        )
    ...
    parser.add_argument('--experiment', type=str, default=None,
                        ...
                        help='Which sampling experiment to validate. '
                             'Auto-sets models_dir, plots_dir, results_dir.')
    parser.add_argument('--models_dir', type=str,
                        default='replicates_outputs',
                        help='Overridden automatically when --experiment is set.')
    parser.add_argument('--data', type=str,
                        default='epidemic_data_age_adaptive_sobol_split_augmented.pkl',
                        help='Dataset file (3-parameter SIR)')
    parser.add_argument('--output_dir', type=str,
                        default='sir3param_validation_results',
                        help='Fallback output dir (overridden by --experiment).')
