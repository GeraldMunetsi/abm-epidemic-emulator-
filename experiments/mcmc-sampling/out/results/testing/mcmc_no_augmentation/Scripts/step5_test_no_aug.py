...
RESULTS_DIR= Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/testing")
PLOTS_DIR= Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/testing")
