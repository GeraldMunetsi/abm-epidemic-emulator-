...
MODEL_DIR=Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/validation")
PLOTS_DIR=Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/validation")
