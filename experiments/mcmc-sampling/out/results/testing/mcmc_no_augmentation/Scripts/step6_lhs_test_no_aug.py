...
RESULTS_DIR= Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/lhs_testing_no_aug")
PLOTS_DIR= Path("experiments/mcmc-sampling/out/results/testing/mcmc_no_augmentation/lhs_testing_no_aug")
...
def plot_infected_only(results_list, targets, plots_dir, n_samples=8):
    ...
    axes = axes.flatten()
    fig.suptitle('MCMC MODEL(NO AUGMENTATION) ON LHS TEST SET (INFECTED (I) COMPARTMENT)',
        fontsize=14,
        fontweight='bold'
    )
