...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default=None,
                         help='Defaults to experiments/Ablation studies/out/results/testing/<condition>/random_test')
    parser.add_argument('--plots_dir',type=str, default=None,
                         help='Defaults to experiments/Ablation studies/out/plots/testing/<condition>/random_test')
    ...
    results_dir = Path(args.output_dir) if args.output_dir else ABLATION_RESULTS_ROOT / CONDITION / 'random_test'
    plots_dir   = Path(args.plots_dir)  if args.plots_dir  else ABLATION_PLOTS_ROOT / CONDITION / 'random_test'
